...
export class SelAndEntryImpl {
    ...
    static changeTextIndentation(
        ...
        let cb = (line: FormattedText) => {
            ...
            let newline = SelAndEntryImpl.setIndentLevel(line, level, true, defaultFont);
            line.deleteAll();
            line.append(newline);
        };
    ...
    static changeTextToggleLinePrefix(
        ...
        let cb = (line: FormattedText) => {
            ...
            if (existingPrefix === prefix) {
                ...
                SelAndEntryImpl.changeTextDeleteSelection(line, lineStart, lineStart + prefix.length);
            } else {
                /* no prefix, add it */
