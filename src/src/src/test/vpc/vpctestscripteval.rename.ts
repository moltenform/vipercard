...
/* auto */ import { Root, assertEq, assertEqWarn } from '../../ui512/utils/utilsUI512.js';
...
export class Test_ScriptEval extends Test_ScriptRun {
    ...
    tests = [
        ...
        () => {
            ...
            batch = [
                ...
                ['(the autohilite of cd btn "p1") or (the autohilite of cd btn "notexist")', 'ERR:find the specified element'],
                ['the locktext of cd fld "p1"', 'false'],
                ['the locktext of cd fld "notexist"', 'ERR:find the specified element'],
                ['(the locktext of cd fld "p1") and (the locktext of cd fld "notexist")', 'ERR:find the specified element'],

                [`put counting() into cfirst
get true or char 1 of counting() is "z"\\counting() - cfirst`, '2'],
                [`put counting() into cfirst
get false and char 1 of counting() is "z"\\counting() - cfirst`, '2']
            ]
            this.testBatchEvaluate(batch)
        },
        "test_getProp",
        ...
        () => {
            ...
            batch = [
                ...
                [`set the name of cd btn id ${this.elIds.btn_b_c_1} to "newname" \\ the short name of cd btn id ${this.elIds.btn_b_c_1}`, 'newname'],
                [`set the name of cd btn id ${this.elIds.btn_b_c_1} to "p1" \\ the short name of cd btn id ${this.elIds.btn_b_c_1}`, 'p1'],
            ...
            let batchWithFld = batch.map((item):[string, string]=>[
                item[0].replace(/ cd btn /g, ' cd fld ').replace(
                    new RegExp(`${this.elIds.btn_b_c_1}`, 'g'), `${this.elIds.fld_b_c_1}`), item[1]])
            ...
            batch = [
                ...
                ['set the textstyle of cd btn "p1" to "bold,italic,underline,outline,shadow,condense,extend"\\the textstyle of cd btn "p1"', 'bold,italic,underline,outline,shadow,condense,extend'],
                ['set the textstyle of cd btn "p1" to bold,italic,underline,outline,shadow,condense,extend\\the textstyle of cd btn "p1"', 'bold,italic,underline,outline,shadow,condense,extend'],
                ['set the textstyle of cd btn "p1" to " Underline , Italic , Bold "\\the textstyle of cd btn "p1"', 'bold,italic,underline'],
            ...
            batch = [
                ...
                ['set the defaulttextfont of cd fld "p1" to "helvetica"\\the defaulttextfont of cd fld "p1"', 'helvetica'],

                // validated get/set
                ['the defaulttextstyle of cd fld "p1"', 'plain'],
                ['set the defaulttextstyle of cd fld "p1" to "outline"\\the defaulttextstyle of cd fld "p1"', 'outline'],
                ['set the defaulttextstyle of cd fld "p1" to " bold , shadow , italic "\\the defaulttextstyle of cd fld "p1"', 'bold,italic,shadow'],
                ['set the defaulttextstyle of cd fld "p1" to " italic , outline, extend, bold "\\the defaulttextstyle of cd fld "p1"', 'bold,italic,outline,extend'],
            ...
            let sfmt = ''
            sfmt += TextRendererFontManager.setInitialFont('ab', new TextFontSpec('Courier', TextFontStyling.Bold, 24).toSpecString())
            sfmt += TextRendererFontManager.setInitialFont('cd', new TextFontSpec('Courier', TextFontStyling.Italic | TextFontStyling.Shadow, 18).toSpecString())
            sfmt += TextRendererFontManager.setInitialFont('ef', new TextFontSpec('Times', TextFontStyling.Default, 18).toSpecString())
            ...
            batch = [
                ...
                ['set the textfont of char 2 to 3 of cd fld "p2" to "geneva"\\the textfont of char 2 to 3 of cd fld "p2"', 'geneva'],
                ['set the textstyle of char 4 to 5 of cd fld "p2" to "underline"\\the textstyle of char 4 to 5 of cd fld "p2"', 'underline'],
                ['set the textsize of char 6 to 6 of cd fld "p2" to "14"\\the textsize of char 6 to 6 of cd fld "p2"', '14'],
            ...
            assertEqWarn('|Courier_24_+biuosdce|a|geneva_24_+biuosdce|b|geneva_18_b+iuo+sdce|c|Courier_18_bi+uosdce|d|Times_18_bi+uosdce|e|Times_14_biuosdce|f', contents.replace(new RegExp(specialCharFontChange, 'g'), '|'), '1x|')
            ...
            batch = [
                ...
                [`the long name of cd btn id ${this.elIds.btn_b_c_1}`, `card button id ${this.elIds.btn_b_c_1} of card id ${this.elIds.card_b_c} of this stack`],
                ...
                [`the long name of cd fld id ${this.elIds.fld_b_c_1}`, `card field id ${this.elIds.fld_b_c_1} of card id ${this.elIds.card_b_c} of this stack`],
        ...
        () => {
            ...
            batch = [
                ...
                \\x > lowBound and x < upperBound`, 'true'],
            ]
            this.testBatchEvaluate(batch)
