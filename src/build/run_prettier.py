...
prettier = r'../src/node_modules/prettier/bin-prettier.js'
tslint = r'../src/node_modules/tslint/bin/tslint'
...
def goTsLint(srcdirectory):
    #~ args = ['node', tslint,  '--type-check', '--config', '../src/tslint.json', file]
    args = ['node', tslint,  '--project', '../src/tsconfig.json', '--config', '../src/tslint.json']
