...
export declare type lookAheadSequence = TokenConstructor[][];
...
export declare class Parser {
     ...
     * @see SUBRULE1
     */
    protected SUBRULE<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
     ...
     */
    protected SUBRULE1<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
     * @see SUBRULE1
     */
    protected SUBRULE2<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
     * @see SUBRULE1
     */
    protected SUBRULE3<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
     * @see SUBRULE1
     */
    protected SUBRULE4<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
     * @see SUBRULE1
     */
    protected SUBRULE5<T>(ruleToCall: (idx: number) => T, args?: any[]): T;
    /**
    ...
    protected subruleInternal<T>(ruleToCall: (idx: number) => T, idx: number, args: any[]): any;
    /**
    ...
    protected lookAheadBuilderForOptional(alt: lookAheadSequence, tokenMatcher: TokenMatcher, dynamicTokensEnabled: boolean): () => boolean;
    protected lookAheadBuilderForAlternatives(alts: lookAheadSequence[], hasPredicates: boolean, tokenMatcher: TokenMatcher, dynamicTokensEnabled: boolean): (orAlts?: IAnyOrAlt<any>[]) => number | undefined;
}
 ...
 * or reused.
 */
export declare const defaultErrorProvider: IErrorMessageProvider;
...
export declare function clearCache(): void;
    ...
    export declare function createSyntaxDiagramsCode(grammar: gast.ISerializedGast[], {resourceBase, css}?: {
    /**
