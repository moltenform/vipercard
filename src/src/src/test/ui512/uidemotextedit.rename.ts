...
/* auto */ import { RenderComplete, Root, Util512, assertEq, cast } from '../../ui512/utils/utilsUI512.js';
/* auto */ import { Tests_BaseClass } from '../../ui512/utils/utilsTest.js';
/* auto */ import { ModifierKeys, ScreenConsts, ScrollConsts, getStandardWindowBounds } from '../../ui512/utils/utilsDrawConstants.js';
...
export class Test_DrawTextEdit extends Tests_BaseClass {
    ...
    addElements(c: UI512Controller, bounds: number[]) {
        ...
        const specialCharNonBreakingSpace = "\xCA";
