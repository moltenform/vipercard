...
/* auto */ import { Util512, checkThrowEq, defaultSort } from '../../ui512/utils/utils512.js';
/* auto */ import { OrdinalOrPosition, SortType, VpcChunkPreposition, VpcChunkType, getPositionFromOrdinalOrPosition } from '../../vpc/vpcutils/vpcEnums.js';
...
/**
 * it turns out to be kind of complicated to evaulate something like
 ...
 * will actually make a lot of commas and make it happen
 *
