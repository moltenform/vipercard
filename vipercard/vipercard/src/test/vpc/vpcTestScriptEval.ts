...
t.test('test_vpcProperties', () => {
        ...
        batch = [
            ...
            [`the short id of cd btn id ${this.elIds.btn_b_c_1}`, `${this.elIds.btn_b_c_1}`],
            [`the long id of cd btn id ${this.elIds.btn_b_c_1}`, `card button id ${this.elIds.btn_b_c_1}`],
            ...
            [`the short id of cd fld id ${this.elIds.fld_b_c_1}`, `${this.elIds.fld_b_c_1}`],
            [`the long id of cd fld id ${this.elIds.fld_b_c_1}`, `card field id ${this.elIds.fld_b_c_1}`],
