...
/* auto */ import { TextFontSpec, TextFontStyling, TextRendererFont, UI512FontGrid, typefacenameToTypefaceIdFull } from '../../ui512/draw/ui512DrawTextClasses.js';

/**
 * cache the font data that has been loaded
 */
export class UI512FontCache {
    ...
    findGrid(font: string): O<UI512FontGrid> {
        ...
        if (found === undefined) {
            ...
            gridkey = UI512FontCache.defaultFontAsId;
