...
declare namespace chevrotain {
    ...
    export const END_OF_FILE: IToken;
    ...
    export type CstChildrenDictionary = {
    ...
    export interface IErrorMessageProvider {
         ...
         */
        buildMismatchTokenMessage?(options: { expected: TokenConstructor; actual: IToken; ruleName: string }): string;
        /**
...
export const ChvLexer = chevrotain.Lexer;
export const ChvParser = chevrotain.Parser;
export const ChvToken = chevrotain.Token;
export type ChvLexer = chevrotain.Lexer;
export type ChvToken = chevrotain.Token;
export type ChvILexingResult = chevrotain.ILexingResult;
export type ChvILexingError = chevrotain.ILexingError;
export type ChvIToken = chevrotain.IToken;
