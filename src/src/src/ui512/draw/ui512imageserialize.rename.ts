...
/* auto */ import { LockableArr, assertEq, base10 } from '../../ui512/utils/utilsUI512.js';
...
export class UI512ImageSerialization {
    ...
    */
    ...
    loadFromString(canvas: CanvasWrapper, compressed: string) {
        ...
        let uncompressed = UI512Compress.decompressString(compressed, false);
    ...
    writeToStringFromData(data: Uint8ClampedArray, w: number, h: number) {
        ...
        return UI512Compress.compressString(result, false);
    }
}
