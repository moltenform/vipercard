...
/* auto */ import { IUI512Session, Root, Util512, base10, checkThrowEq } from '../../ui512/utils/utilsUI512.js';
...
export class VpcSession implements IUI512Session {
    ...
    static fromRoot(root: Root): O<VpcSession> {
        let got = root.getSession();
