...
export class TestVpcScriptRunCustomFns extends TestVpcScriptRunBase {
    tests = [
        'async/vpctestscriptRunCustomFnsInit',
        async () => {
...
\\ret && countCalls`,
        ...
        "test_don't need to expand custom fns on these lines",
        () => {
...
on myHandler
    global a, myFn(1, 2)
        ...
        'test_expand in VpcLineCategory.ReturnExpr',
        () => {
            this.provideCustomFnInStackScript(`
on theTest
    global countCalls
...
`);
        ...
        'test_expand in VpcLineCategory.IfStart',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
if myMult(myMult(3, x), 2) is 24 then
    if myMult(4, 5) is 20 then
        ...
        'test_expand in VpcLineCategory.IfElse',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
repeat myMult(1,3)
    put "-" after s
        ...
        'test_expand in repeat while/until',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
repeat while x < myMult(2,3)
    ...
    add 1 to x
        ...
        'test_expand in VpcLineCategory.built in command',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
{RESULT}x`,
        ...
        'test_expand in VpcLineCategory.GoCardImpl',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
\\ret && countCalls`,
        ...
        'test_expand in VpcLineCategory.CallDynamic',
        () => {
            this.provideCustomFnInStackScript();
            let batch: [string, string][] = [
                ['global countCalls\\0', '0'],
...
\\g && countCalls`,
        ...
        'test_expand in VpcLineCategory.CallHandler',
        () => {
            this.provideCustomFnInStackScript(`
on theTest p1, p2
    global g
...
\\g && countCalls`,
    ...
    provideCustomFnInStackScript(addCode = '') {
        let stack = this.vcstate.model.getById(this.elIds.stack, VpcElStack);
