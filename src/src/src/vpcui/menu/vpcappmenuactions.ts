...
/* auto */ import { makeVpcInternalErr } from '../../ui512/utils/utilsAssert.js';
/* auto */ import { BrowserOSInfo, Root } from '../../ui512/utils/utilsUI512.js';
...
export class VpcMenuActions {
    ...
    constructor(protected root: Root, protected appli: IVpcStateInterface) {
        this.fontChanger = new VpcChangeSelectedFont(root, appli);
    }
    ...
    go_mnuOSAbout() {
        ...
        VpcAboutDialog.show(this.root, c, dlg);
    }

    go_mnuOSDonate() {
        let c = this.appli.getController();
        let dlg = new UI512CompStdDialog('OSAboutDlg', this.appli.lang());
        VpcAboutDialog.showDonateIndirectly(this.root, c, dlg);
    }

    go_mnuReportErr() {
        if (this.root.getSession()) {
    ...
    go_mnuCopyCardOrVel() {
        ...
        if (selected) {
            ...
            throw makeVpcInternalErr('Simple Notification: ' + 'This feature has not yet been developed.');
        }
    }
    ...
    go_mnuCreateManyButtons() {
        ...
        throw makeVpcInternalErr('Simple Notification: ' + 'First id: ' + firstidgot);
    }
    ...
    go_mnuPaintManyCopies() {
        let keyname = this.root.getBrowserInfo() === BrowserOSInfo.Mac ? 'Option' : 'Alt';
        throw makeVpcInternalErr(
            'Simple Notification: ' +
                this.appli
                    .lang()
