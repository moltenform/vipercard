...
/* auto */ import { ScreenConsts, ScrollConsts } from '../../ui512/utils/utilsDrawConstants.js';
...
/* auto */ import { TestTextEventInteractions } from '../../test/ui512/testUI512TextEditInteractions.js';
 ...
 * 2) you can start this project in _rootUI512.ts_ (uncomment the line referencing _UI512DemoTextEdit_) to confirm that manually
...
export class TestDrawUI512TextEdit extends UI512TestBase {
    ...
    tests = [
        ...
        async () => {
            await UI512RenderAndCompareImages(false, () => this.testDrawTextEdit());
        }
    ];
    ...
    protected addElementsUpperLeft(grp: UI512ElGroup, pr: UI512Presenter, b0: number, b1: number) {
        ...
        layoutStyles.createElems(pr.app, grp, 'testStyles', UI512ElTextField, (a, b, el) => {
            el.set('style', a);
