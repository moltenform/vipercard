...
async function createUserTests(callback: Function) {
    let cb = async () => {
...
async function checkLoginAndEmailVerifyTests(callback: Function) {
...
async function createLogEntryTests(callback: Function) {
...
async function createStacksTests(tst: TestVpcServerTests, callback: Function) {
...
async function getStacksTests(tst: TestVpcServerTests, callback: Function) {
    await sleep(4000);
...
async function updateStacksTests(tst: TestVpcServerTests, callback: Function) {
...
export class TestVpcServerTests extends UI512TestBase {
    stackId1 = '';
    stackId2 = '';
    stackId3 = '';
    fakeStackData1 = '';
