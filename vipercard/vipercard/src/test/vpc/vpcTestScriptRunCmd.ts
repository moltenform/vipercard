...
t.test('execCommands choose', () => {
    ...
    b.t('choose tool "pencil" "tool"\\tool()', 'ERR:NotAllInputParsedException');
    b.t('choose', 'PREPARSEERR:not enough args');
    b.t('choose brush', 'PREPARSEERR:tool');
    b.t('choose 3', 'PREPARSEERR:tool');
    b.t('choose pencil', 'PREPARSEERR:tool');
    b.t('choose abc', 'PREPARSEERR:tool');
    b.t('choose pencil def', 'PREPARSEERR:tool');
...
t.test('execCommands arithmetic invalid parse', () => {
    ...
    let b = new ScriptTestBatch();
    b.t('add 4 with cd fld "p1"', 'ERR:3:MismatchedTokenException');
    b.t('add 4 into cd fld "p1"', 'ERR:3:MismatchedTokenException');
    b.t('add 4 from cd fld "p1"', 'ERR:3:MismatchedTokenException');
    b.t('add 4 from cd fld "to"', 'ERR:3:MismatchedTokenException');
    b.t('add 4 to', 'ERR:3:NoViableAltException');
    b.t('add to cd fld "p1"', 'ERR:3:NoViableAltException');
    b.t('subtract 4 with cd fld "p1"', 'PREPARSEERR:3:did not see');
    b.t('subtract 4 into cd fld "p1"', 'PREPARSEERR:3:did not see');
    b.t('subtract 4 to cd fld "p1"', 'PREPARSEERR:3:did not see');
    b.t('subtract 4 to cd fld "from"', 'PREPARSEERR:3:did not see');
    b.t('subtract 4 from', 'ERR:3:NoViableAltException');
    b.t('subtract from cd fld "p1"', 'ERR:3:NoViableAltException');
    b.t('divide cd fld "p1"', 'PREPARSEERR:3:did not see');
    b.t('divide cd fld "p1" to 4', 'PREPARSEERR:3:did not see');
    b.t('divide cd fld "p1" with 4', 'PREPARSEERR:3:did not see');
    b.t('divide cd fld "p1" from 4', 'PREPARSEERR:3:did not see');
    b.t('divide cd fld "by" from 4', 'PREPARSEERR:3:did not see');
    b.t('divide cd fld "p1" by', 'ERR:3:NoViableAltException');
    b.t('multiply cd fld "p1"', 'PREPARSEERR:3:did not see');
    b.t('multiply cd fld "p1" to 4', 'PREPARSEERR:3:did not see');
    b.t('multiply cd fld "p1" with 4', 'PREPARSEERR:3:did not see');
    b.t('multiply cd fld "p1" from 4', 'PREPARSEERR:3:did not see');
    b.t('multiply cd fld "by" from 4', 'PREPARSEERR:3:did not see');
    b.t('multiply cd fld "p1" by', 'ERR:3:NoViableAltException');
    b.batchEvaluate(h);
});
...
t.test('execCommands put', () => {
    ...
    b.t('put "abc" into line 1 to into of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" into line 1 to before of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" into line 1 to after of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before line 1 to into of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before line 1 to before of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before line 1 to after of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after line 1 to into of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after line 1 to before of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after line 1 to after of cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" into into cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" into after cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" into before cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before into cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before after cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" before before cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after into cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after after cd fld "p1"', 'PREPARSEERR:only see one');
    b.t('put "abc" after before cd fld "p1"', 'PREPARSEERR:only see one');
