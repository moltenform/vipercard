...
export class UI512CompStdDialog extends UI512CompBase {
    ...
    autoRegisterAndSuppressAndRestore(
        ...
        ctrl.listenEvent(UI512EventType.MouseDown, (c: UI512Controller, rootPar: Root, d: MouseDownEventDetails) => {
        ...
        ctrl.listenEvent(UI512EventType.MouseUp, (c: UI512Controller, root2: Root, d: MouseUpEventDetails) => {
