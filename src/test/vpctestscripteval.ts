...
get false and char 1 of counting() is "z"\\counting() - cfirst`,
        ...
        () => {
            ...
            batch = [
                ...
                [
                    `set the name of cd btn id ${this.elIds.btn_b_c_1} to "newname" \\ the short name of cd btn id ${this.elIds.btn_b_c_1}`,
                    "newname",
                ],
            ...
            let batchWithFld = batch.map((item): [string, string] => [
                item[0].replace(/ cd btn /g, " cd fld ").replace(new RegExp(`${this.elIds.btn_b_c_1}`, "g"), `${this.elIds.fld_b_c_1}`),
                item[1],
            ]);
        ...
        () => {
            ...
            batch = [
                ...
                ["optionkey()", "false"],
                ["shiftkey()", "false"],
                ["clickh()", `${this.simClickX}`],
                ["clickv()", `${this.simClickY}`],
                ["clickloc()", `${this.simClickX},${this.simClickY}`],
                ["mouse()", `up`],
                ["mouseclick()", `true`],
                ["mouseh()", `${this.simMouseX}`],
                ["mousev()", `${this.simMouseY}`],
                ["mouseloc()", `${this.simMouseX},${this.simMouseY}`],
                ["param(0)", ``],
                ["param(1)", ``],
                ["param(2)", ``],
                ["paramcount()", `0`],
