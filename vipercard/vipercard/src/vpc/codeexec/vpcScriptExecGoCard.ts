...
/* auto */ import { IntermedMapOfIntermedVals, VpcValN, VpcValS } from './../vpcutils/vpcVal';
...
export class VpcExecGoCardHelpers {
    ...
    protected valsToReferencedCardId(vals: IntermedMapOfIntermedVals):O<string> {
        ...
        if (vals.vals.TokenTkstringliteral && vals.vals.TokenTkstringliteral.length > 1) {
            ...
            return this.goBackOrForth(vals.vals.TokenTkstringliteral[1] as string, this.outside.GetCurrentCardId())
        } else if (ref) {
