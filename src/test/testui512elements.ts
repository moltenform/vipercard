...
export class Test_ui512Elements extends Tests_BaseClass {
    tests = [
        ...
        () => {
            ...
            assertEq(ModifierKeys.Shift | ModifierKeys.Opt, osTranslateModifiers(BrowserOSInfo.Windows, false, true, true, true), "");
            ...
            assertEq(ModifierKeys.Shift | ModifierKeys.Opt, osTranslateModifiers(BrowserOSInfo.Linux, false, true, true, true), "");
