...
export class TestTextEventInteractions {
    ...
    simulateClick(pr: UI512Presenter, x: number, y: number, doubleclick = false, isShift = false) {
    ...
    simulateKey(pr: UI512Presenter, keyCode: string, keyChar: string, isShift: boolean, isCmd = false) {
        let mods = isShift ? ModifierKeys.Shift : ModifierKeys.None;
