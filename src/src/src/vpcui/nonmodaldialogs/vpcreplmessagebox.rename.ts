...
export class VpcAppNonModalDialogReplBox extends VpcFormNonModalDialogBase {
    ...
    createSpecific(app: UI512Application, lang: UI512Lang) {
        ...
        this.appli.getController().setCurrentFocus(this.appli.getRoot(), this.entry.id);
    ...
    appendToOutput(s: string, truncElipses: boolean) {
        ...
        SelAndEntry.changeSelGoDocHomeEnd(this.appli.getRoot(), gel, false /* isLeft*/, false /* isExtend*/);
    }
