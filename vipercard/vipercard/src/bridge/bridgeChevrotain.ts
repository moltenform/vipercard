...
// this file is basically the standard chevrotain typing pasted here, but put inside a namespace.
// and added a declare or abstract to a couple functions inside
// and see export statements below
// I do this because when building for es6 modules, any import statements are left in the output.
//
// in the past I made a custom chevrotain to avoid a call to new Function(), which is basically eval.;

/* check_long_lines_silence_subsequent */
/* eslint-disable */

export declare namespace chevrotain {
    ...
    export abstract class GAstVisitor {
        abstract visit(node: IProduction): any;
    ...
    export declare class Option
        ...
        constructor(options: { definition: IProduction[]; idx?: number; name?: string });
     ...
     * - See detailed docs for [Custom APIs](http://sap.github.io/chevrotain/docs/guide/custom_apis.html)
     */
    export declare function assignOccurrenceIndices(options: { rules: Rule[] }): void;
