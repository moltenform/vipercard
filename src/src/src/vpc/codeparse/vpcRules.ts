...
export class ChvParserClass extends ChvParser {
    ...
    public RuleHChunkAmt = this.RULE('RuleHChunkAmt', () => {
        this.OR1([
            {
                ALT: () => {
    ...
    public RuleBuiltinCmdPlay = this.RULE('RuleBuiltinCmdPlay', () => {
        this.CONSUME1(tks.TokenTkidentifier);
        this.SUBRULE1(this.RuleExpr);
        this.OPTION1(() => {
            this.CONSUME2(tks.TokenTkidentifier);
    ...
    public RuleFnCallWithoutParensOrGlobalGetPropOrTarget = this.RULE(
        'RuleFnCallWithoutParensOrGlobalGetPropOrTarget',
        () => {
            this.CONSUME1(tks.TokenThe);
            this.OPTION1(() => {
