...
let t = new SimpleUtil512TestCollection('testCollection03chunkDelete');
export let testCollection03chunkDelete = t;

t.atest('--init--testCollection03chunkDelete', async () => {
