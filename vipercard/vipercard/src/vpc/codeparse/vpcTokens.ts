...
return t.tokenType === tks.tkIdentifier ||t.tokenType === tks._number ||t.tokenType === tks.tkA ||t.tokenType === tks.tkAllUnaryPropertiesIfNotAlready ||t.tokenType === tks.tkAllNullaryOrUnaryPropertiesIfNotAlready 
}
