...
/* auto */ import { O, UI512Compress, assertTrue, makeUI512Error } from '../../ui512/utils/utilsAssert.js';
/* auto */ import { OrderedHash, Util512, assertEq, defaultSort, findEnumToStr, findStrToEnum, fitIntoInclusive, setarr } from '../../ui512/utils/utilsUI512.js';
    ...
    tests = [
        ...
        () => {
            ...
            for (let escapeNewlines of [false, true]) {
                assertEq("\u2020 ", UI512Compress.compressString("", escapeNewlines), "")
                assertEq("\u10E8 ", UI512Compress.compressString("a", escapeNewlines), "")
                assertEq("\u10E6\u4866\u4AEA  ", UI512Compress.compressString("aaaaaaaabbbbbbbb", escapeNewlines), "")
                assertEq("\u10E6\u4866\u4AE8\u31B0 ", UI512Compress.compressString("aaaaaaaabbbbbbbbc", escapeNewlines), "")
                assertEq("\u10E6\u7070\u0256\u4CF0 ", UI512Compress.compressString("aaaaaaa\nbbbbbbbbb", escapeNewlines), "")
                assertEq("", UI512Compress.decompressString("\u2020 ", escapeNewlines), "")
                assertEq("a", UI512Compress.decompressString("\u10E8 ", escapeNewlines), "")
                assertEq("aaaaaaaabbbbbbbb", UI512Compress.decompressString("\u10E6\u4866\u4AEA  ", escapeNewlines), "")
                assertEq("aaaaaaaabbbbbbbbc", UI512Compress.decompressString("\u10E6\u4866\u4AE8\u31B0 ", escapeNewlines), "")
                assertEq("aaaaaaa\nbbbbbbbbb", UI512Compress.decompressString("\u10E6\u7070\u0256\u4CF0 ", escapeNewlines), "")
            }
            ...
            try {
                ...
                assertEq("fake\nfake", UI512Compress.compressString("a", false), "")
                assertEq("fake##Newline##fake", UI512Compress.compressString("a", true), "")
                LZString.compressToUTF16 = (s:string) => "fake\nfake\nfake"
                assertEq("fake\nfake\nfake", UI512Compress.compressString("a", false), "")
                assertEq("fake##Newline##fake##Newline##fake", UI512Compress.compressString("a", true), "")
            } finally {
            ...
            try {
                ...
                assertEq("fake##Newline##fake", UI512Compress.compressString("a", false), "")
                this.assertThrows("", "cannot compress", () => UI512Compress.compressString("a", true))
            } finally {
                LZString.compressToUTF16 = realCompress
            }
        },
